...
1. Open the S3 console and upload a small video file to the 'Input Storage Bucket' which was returned when you ran amplify push. You can download and upload [this sample clip](https://master.dr1ni75won2nc.amplifyapp.com/unicornflix/sample.mp4) if you don't have your own video handy.
